...
class SymbolicAgentDQNv2:
	...
	def _build_model(self):
		...
		state_input = Input(shape = ((self.interaction_max_distance*2)*(self.interaction_max_distance*2) *2,))
	...
	def create_vector_representation(self, interactions):
		...
		type_loc_matrix = np.zeros((2,self.interaction_max_distance*2, self.interaction_max_distance*2))

		for i in interactions:

			type_loc_matrix[i.entity_type2 -2][i.x_dist][i.y_dist] = 1

		return type_loc_matrix.flatten()
